  ...
  async function handleCreate(e: React.FormEvent) {
    ...
    try {
      const res = await fetch('/api/channel/create', {
        ...
        body: JSON.stringify({ workspace_id: workspaceId, name: slugName, description: description || null, is_private: isPrivate }),
      })
    ...
    <div style={overlay} onClick={e => e.target === e.currentTarget && onClose()}>
      <div style={modal}>
        ...
        <p style={{ color: '#72767d', fontSize: 14, marginTop: 4, marginBottom: 20 }}>
          Channels are where your team communicates. Best when organized around a topic.
        </p>
        <form onSubmit={handleCreate} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          <div>
            ...
            <div style={{ position: 'relative' }}>
              ...
              <input value={name} onChange={e => setName(e.target.value)} placeholder="e.g. marketing, q4-planning" required maxLength={80}
